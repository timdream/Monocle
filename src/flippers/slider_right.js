Monocle.Flippers.SliderRight = function (reader) {
  if (Monocle.Flippers == this) {
    return new Monocle.Flippers.SliderRight(reader);
  }

  var API = { constructor: Monocle.Flippers.SliderRight }
  ...
  */
  ...
  function jumpOut(pageDiv, callback) {
    var dur = Monocle.Browser.has.jumpFlickerBug ? 1 : 0;
    setX(pageDiv, pageDiv.offsetWidth, { duration: dur }, callback);
  }
  ...
  function slideOut(callback) {
    ...
    setX(upperPage(), upperPage().offsetWidth, slideOpts, callback);
  }
