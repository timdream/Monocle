...
// one page.
//
Monocle.Panels.TwoPaneRight = function (flipper, evtCallbacks) {

  var API = { constructor: Monocle.Panels.TwoPaneRight }
  ...
  function initialize() {
    ...
    for (dir in p.panels) {
      ...
      style[(dir == "backwards" ? "right" : "left")] = 0;
...
Monocle.Panels.TwoPaneRight.WIDTH = "50%";

Monocle.pieceLoaded('panels/twopane_right');
