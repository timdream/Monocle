...
//
Monocle.Panels.MarginalRight = function (flipper, evtCallbacks) {

  var API = { constructor: Monocle.Panels.MarginalRight }
...
Monocle.pieceLoaded('panels/marginal_right');
